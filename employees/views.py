...
def home(request):
    ...
    product_stats = Producto.objects.annotate(sales=Sum('ordendetalle__cantidad'))
    top_products = product_stats.filter(sales__gt=0).order_by('-sales')[:5]
    ...
    for i in top_products:
        ...
        product_stat_sales_data.append(i.sales)
