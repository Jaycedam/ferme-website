...
class ProductoFilter(django_filters.FilterSet): 
    ...
    marca = ModelMultipleChoiceFilter(field_name='id_marca', label='Marca', queryset=Marca.objects.all(), widget=forms.CheckboxSelectMultiple)
...
class ProductoAdminFilter(django_filters.FilterSet): 
    ...
    class Meta:
        model = Producto
        fields = ['id_producto', 'producto', 'id_tipo_producto', 'id_marca', 'stock', 'stock_critico', 'id_proveedor']
